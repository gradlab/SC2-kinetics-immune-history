...
## Only the titer sensitivity group
...
## BASELINE. Just time since detection
    ...
    save(fit, file=paste0("outputs/titer_models_sensitivity/",filename,".RData"))
} else {
    load(paste0("outputs/titer_models_sensitivity/",filename,".RData"))
}
