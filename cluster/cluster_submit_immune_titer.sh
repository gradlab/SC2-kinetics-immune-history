...
R CMD BATCH --quiet --no-restore --no-save cluster/brm_regression_cluster_immune_with_titer.R jobout/${SLURM_JOB_NAME}/run_${SLURM_ARRAY_TASK_ID}.Rout
